...
http.createServer(function (req, res) {
    ...
    if(req.url == "/" || req.url.indexOf('.html') != -1){ //req.url has the pathname, check if it conatins '.html'
      ...
      fs.readFile( '/home/pi/homecloud/ftw_page/ftw_page.html', function (err, data) {
    ...
    if(req.url.indexOf('.js') != -1){ //req.url has the pathname, check if it conatins '.js'
      ...
      fs.readFile('/home/pi/homecloud/ftw_page/ftw_page.js', function (err, data) {
        if (err) console.log(err);
    ...
    if(req.url.indexOf('.css') != -1){ //req.url has the pathname, check if it conatins '.css'
      ...
      fs.readFile('/home/pi/homecloud/ftw_page/ftw_page.css', function (err, data) {
        if (err) console.log(err);
